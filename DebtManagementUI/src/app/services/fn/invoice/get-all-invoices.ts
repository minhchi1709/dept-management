...
export function getAllInvoices(http: HttpClient, rootUrl: string, params?: GetAllInvoices$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Invoice>>> {
