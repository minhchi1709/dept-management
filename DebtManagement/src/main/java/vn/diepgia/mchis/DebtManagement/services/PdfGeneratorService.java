...
public class PdfGeneratorService {
    ...
    public String generatePdf(Invoice invoice)  {
        try {
            ...
            // Left Chunk
            leftCell = new PdfPCell(new Phrase("Địa chỉ: Lô 7 Cụm Công Nghiệp Nhị Xuân - Ấp 5 - Xã Xuân Thới Sơn - Hóc môn", new Font(bf, 10)));
            leftCell.setBorder(PdfPCell.NO_BORDER); // Remove cell borders
            table.addCell(leftCell);

            // Right Chunk
            rightCell = new PdfPCell(new Phrase("Lưu khách hàng", textFont));
            rightCell.setPaddingRight(10f);
            rightCell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT); // Align text to the right
            rightCell.setBorder(PdfPCell.NO_BORDER); // Remove cell borders
            table.addCell(rightCell);
            ...
            // Left Chunk
            leftCell = new PdfPCell(new Phrase("CÔNG TY TNHH SX TM DIỆP GIA", new Font(bf, 12, Font.BOLD)));
            leftCell.setBorder(PdfPCell.NO_BORDER); // Remove cell borders
            table.addCell(leftCell);
            ...
            temp.add(new Chunk("Số phiếu: ",  new Font(bf, 10, Font.BOLD)));
            temp.add(new Chunk(invoice.getId(), textFont));
            rightCell = new PdfPCell(new Phrase(temp));
            rightCell.setPaddingRight(10f);
            rightCell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT); // Align text to the right
            rightCell.setBorder(PdfPCell.NO_BORDER); // Remove cell borders
            table.addCell(rightCell);
            ...
            // Right Chunk
            rightCell = new PdfPCell(new Phrase("Lưu công ty", textFont));
            rightCell.setPaddingRight(10f);
            rightCell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT); // Align text to the right
            rightCell.setBorder(PdfPCell.NO_BORDER); // Remove cell borders
            table.addCell(rightCell);
